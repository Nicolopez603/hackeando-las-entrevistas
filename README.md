...
- Diferentes tipos de pruebas: Perfomance, Seguridad, Accesibilidad, etc.
...
- ¿Qué es la Programación Orientada a Objetos y cómo se aplica en la automatización de pruebas?
- ¿Qué herramientas de automatización has utilizado en tus proyectos?
- ¿Qué es POM y cuál es su importancia en la automatización de pruebas?
- ¿Cómo eliges un selector adecuado para identificar elementos en la interfaz de usuario?
- ¿Cuáles son las estrategias comunes para seleccionar elementos en la automatización de pruebas?
- ¿Cómo priorizas los casos de prueba para la automatización?
- ¿Cómo garantizas que la automatización de pruebas perdure a lo largo del tiempo?
- ¿Cuáles son los errores más comunes que pueden ocurrir en un proyecto de automatización?
- ¿Qué son los patrones de diseño y cómo se aplican en la automatización de pruebas? ¿Cuáles has utilizado?
- ¿Qué significa la palabra clave "static" en programación y cómo se utiliza en el contexto de la automatización?
- ¿Qué es un bloque try/catch y cómo se utiliza para el manejo de excepciones en la automatización de pruebas?
- ¿Qué herramientas de integración continua conoces y cuáles has utilizado? Proporciona ejemplos de uso.
- Qué es el polimorfismo y la sobrecarga de métodos y cómo se aplican en la automatización de pruebas?
- ¿Cuál es la diferencia entre los modificadores de acceso public, private y protected en la programación orientada a objetos?
- ¿Cuántos casos de prueba has automatizado en tu proyecto actual / cuántos tiene tu suite de regresión?
...
- ¿Cuál es la forma ideal de mantener un buen equilibrio entre la vida laboral y personal?
- ¿Se ha estresado por la entrega de algún proyecto en el pasado? ¿Afectó a su conciliación? ¿Cómo lo solucionó?
- ¿Qué opina de las vacaciones y de su influencia en la conciliación de la vida laboral y familiar?
